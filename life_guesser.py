...
guesses, live_list = [], [],
probability_list = []
testing_data = ["6868686886868868688686866866868686886868688868688686886868686686868686868868686868686886"]
training_data = ["5"]
tester = []
import time
...
final_incorrect = 0
while 1==1:
    print("I am processing, please don't type yet")
    print(len(guesses))
    if len(guesses) > 5:
        model_outcome = learn()
        final_guess = Get_Probabilities(guesses, model_outcome[-4] ,model_outcome[-3], model_outcome[-2], model_outcome[-1])
    else:
        final_guess = random.randint(1, 9)
    text_from_user = input("Type a number from 1 to 9!")
